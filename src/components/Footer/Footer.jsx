  ...
  return (
    <div className="pt-8 pb-12 flex flex-col items-center justify-center">
      ...
      <div className="flex text-3xl gap-5 mt-4 text-white dark:text-gray-400">
        <a href='https://github.com/nhimc9x' className="dark:bg-gray-800 rounded bg-slate-500 hover:-translate-y-1 duration-300 hover:text-cmu-primary-400 size-11 grid place-content-center">
          <LuGithub />
        </a>
        <a href='' className="dark:bg-gray-800 rounded bg-slate-500 hover:-translate-y-1 duration-300 hover:text-cmu-primary-400 size-11 grid place-content-center">
          <HiOutlineMail />
        </a>
        <a href='' className="dark:bg-gray-800 rounded bg-slate-500 hover:-translate-y-1 duration-300 hover:text-cmu-primary-400 size-11 grid place-content-center">
          <IoPersonOutline />
