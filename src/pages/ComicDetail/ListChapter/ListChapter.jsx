...
function ListChapter({ comicId, listChapter }) {
  return (
    <div className="relative mt-14 -mx-4 xs:mx-0 md:mx-4 mdl:mx-10 p-[3%]">
      ...
      <div className="bg-black/20">
        ...
        <div className="overflow-y-auto h-[520px] mx-2 xs:mx-4 md:mx-8 border-2 text-gray-200 border-gray-200 rounded-md p-2 text-xl divide-y divide-gray-400">
          {listChapter?.map(chapter =>
            <NavLink
              to={`/comics/${comicId}/chapters/${chapter?.id}`}
              key={chapter?.id}
              className="py-2 xs:pl-4 pl-1 block hover:bg-white dark:hover:bg-[#2f2f2f] hover:text-cmu-primary-500">
